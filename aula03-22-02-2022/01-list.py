...
Data: 24/02/2022
Professor: Henrique Junqueira Branco
Enunciado: Introdução aos tipos de dados - listas
"""


# lista é um tipo que dado que coloco um monte de coisa dentro dele
# método é uma função especifica de algum objeto (lista, string, etc)
# para armazenar valores, podem ser usadas variáveis, listas e tuplas. Uma variável guarda um único valor; listas e tuplas podem guardar vários valores.
#  As listas podem ser manipuladas (pode-se inserir elementos, remover elementos, ordenar a lista, ...). As tuplas apenas guardam os valores, sem a possibilidade de ter seus elementos alterados.
